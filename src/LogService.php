...
class LogService
{
    ...
    const LOG_API = 'API';
    const LOG_EXCEL = 'EXCEL';

    private static $loggers = array();

    // 获取一个实例
    public static function getLogger( $path  ,$type = self::LOG_ERROR, $day = 30)
    {
...
*/
            $handler = (new RotatingFileHandler($path   , $day))
                ->setFormatter(new LineFormatter(null, null, true, true));
    ...
    */
    ...
    {
        return self::write($str, LogService::LOG_EXCEL, 1);
    }
